...
string task5(int n)//если использовать условие файла task12, который лежит на моем GitHub в папке task,
//то календарь работает правильно. Используя этот же алгоритм, но изменив массивы, 
//можно было бы добиться идеальной работы для существующего китайского календаря
{
